...
set(ANTLR_VER "3.4" CACHE STRING "ANTLR runtime and buildtime version.")
set(ANTLR_BUILDTIME_DEP "antlr-${ANTLR_VER}-complete" CACHE STRING "ANTLR buildtime jar file name.")
set(ANTLR_RUNTIME_DEP "antlr-runtime-${ANTLR_VER}" CACHE STRING "ANTLR runtime jar file name.")
set(ANTLR_PATH "/usr/local/ANTLR/${ANTLR_VER}" CACHE PATH "Location of ANTLR runtime and buildtime jar files.")

...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  IF ( NOT MAKE_DOCS_ONLY )
    ...
    # Generic dependencies that are the same across all distributions are found here
    set(DEPENDENCY_LIST "rsync" "zip" "expect")

      IF (USE_BINUTILS AND NOT WIN32)
        find_package(BINUTILS)
        IF (BINUTILS_FOUND)
          add_definitions (-D_USE_BINUTILS)
          if("${packageRevision}" STREQUAL "trusty")
            list(APPEND DEPENDENCY_LIST "binutils"
          endif()
        ELSE()
      ...
      IF (USE_OPENLDAP)
        ...
        IF (OPENLDAP_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "openldap")
          elseif("${packageRevision}" STREQUAL "trusty")
            list(APPEND DEPENDENCY_LIST "libldap-2.4-2")
          endif()
        ELSE()
      ...
      IF (USE_ICU)
        ...
        IF (ICU_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "libicu")
          elseif("${packageRevision}" STREQUAL "trusty")
            list(APPEND DEPENDENCY_LIST "libicu52")
          endif()
        ELSE()
      ...
      if(USE_XALAN)
        ...
        if (XALAN_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "xalan-c")
          elseif("${packageRevision}" STREQUAL "trusty")
            list(APPEND DEPENDENCY_LIST "libxalan-c111")
          endif()
        else()
      ...
      if(USE_LIBXSLT)
        ...
        if (LIBXSLT_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el6" OR "${packageRevision}" STREQUAL "el7")
            list(APPEND DEPENDENCY_LIST "libxslt"
          endif()
        else()
      ...
      if(USE_XERCES)
        ...
        if (XERCES_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "xerces-c")
          elseif("${packageRevision}" STREQUAL "trusty")
            list(APPEND DEPENDENCY_LIST "libxerces-c3.1")
          endif()
        else()
      ...
      if(USE_LIBXML2)
        ...
        if (LIBXML2_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el6" OR "${packageRevision}" STREQUAL "el7")
            list(APPEND DEPENDENCY_LIST "libxml2") 
          endif()
        else()
      ...
      if(USE_BOOST_REGEX)
        ...
        if (BOOST_REGEX_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "boost141-regex")
          endif()
        else()
      ...
      if(USE_APR)
        ...
        if (APR_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el7" OR "${packageRevision}" STREQUAL "el6" OR "${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "apr")
          endif()
        else()
        ...
        if (APRUTIL_FOUND)
          ...
          if ("${packageRevision}" STREQUAL "el7" OR "${packageRevision}" STREQUAL "el6" OR "${packageRevision}" STREQUAL "el5")
            list(APPEND DEPENDENCY_LIST "apr-util")
          endif()
        else()
  ...
  #TODO# handle suse builds
  string(REPLACE ";" ", " RUNTIME_DEPENDENCIES "${DEPENDENCY_LIST}")
  if( "${packageRevision}" STREQUAL "el5" OR "${packageRevision}" STREQUAL "el6")
    set(CPACK_RPM_PACKAGE_REQUIRES RUNTIME_DEPENDENCIES)
  else()
    set(CPACK_DEBIAN_PACKAGE_DEPENDS RUNTIME_DEPENDENCIES)
  endif()

...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  option(MAKE_PLATFORM "Create a package for the platform" ON)
  # Making any of the following plugins will disable the packaging of PLATFORM
  option(MAKE_R_PLUGIN "Create a package with ONLY the R plugin" OFF )
  option(MAKE_MYSQL_PLUGIN "Enable MySQL support" OFF )
  option(MAKE_CASSANDRA_PLUGIN "Enable Cassandra support" OFF )
  option(MAKE_SQLITE3_PLUGIN "Enable SqLite3 support" OFF )
  option(MAKE_PYTHON_PLUGIN "Enable Python support" OFF )
  option(MAKE_V8_PLUGIN "Enable V8 JavaScript support" OFF )
  option(MAKE_JNI_PLUGIN "Enable Java JNI support" OFF )
  option(MAKE_RINSIDE_PLUGIN "Enable R support" OFF )
  option(MAKE_MEMCACHED_PLUGIN "Enable Memcached support" OFF )
  option(MAKE_REDIS_PLUGIN "Enable Redis support" OFF )

  # TODO Deal with mutual exclusion of MAKE options

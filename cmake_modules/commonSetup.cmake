...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
    ...
    set (CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -O0 -D_DEBUG -DDEBUG")
    ...
    if ( PLATFORM OR PLUGINS )
        set(CMAKE_INSTALL_PREFIX "${INSTALL_PATH}" CACHE PATH "Cmake installation prefix" FORCE)
    else()
        set(CMAKE_INSTALL_PREFIX "${INSTALL_PATH}/${version}/clienttools" CACHE PATH "Cmake installation prefix" FORCE)
    endif()
    # build-config.h setup block
    if(NOT "$ENV{DESTDIR}" STREQUAL "")
        message(STATUS "Appending $ENV{DESTDIR} to the installation path")
    endif()
    set(ABS_INSTALL_DIR "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}")
    set(ABS_CONFIG_DIR "$ENV{DESTDIR}${CONFIG_DIR}")
    set(ABS_INIT_DIR "$ENV{DESTDIR}${INIT_DIR}")
    set(ABS_EXEC_PREFIX "$ENV{DESTDIR}${EXEC_PREFIX}")
    set(ABS_CONFIG_PREFIX "$ENV{DESTDIR}${CONFIG_PREFIX}")
    set(ABS_COMPONENTFILES_DIR "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${COMP_DIR}")
    set(ABS_SBIN_DIR "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${SBIN_DIR}")
    set(ABS_RUNTIME_PATH "$ENV{DESTDIR}${RUNTIME_PATH}")
    set(ABS_LOG_PATH "$ENV{DESTDIR}${LOG_PATH}")
    set(ABS_LOCK_PATH "$ENV{DESTDIR}${LOCK_PATH}")
    set(ABS_PID_PATH "$ENV{DESTDIR}${PID_PATH}")
    set(BB_RUNTIME_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/lib")
    set(BB_PID_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/run")
    set(BB_LOCK_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/lock")
    set(BB_LOG_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/log")
    set(BB_CONFIG_PATH "$ENV{DESTDIR}${CONFIG_PREFIX}")

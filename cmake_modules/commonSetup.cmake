...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if(UNIX AND SIGN_MODULES)
    ...
    install(FILES ${CMAKE_BINARY_DIR}/pub.key DESTINATION ${CONF_DIR}/${SOURCE_DIR}  COMPONENT Runtime)
  endif()
  ...
  set(ABS_INSTALL_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}")
  set(ABS_COMP_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${COMP_DIR}")
  set(ABS_LIB_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${LIB_DIR}")
  set(ABS_EXEC_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${BIN_DIR}")
  set(ABS_SBIN_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${SBIN_DIR}")
  set(ABS_CLASS_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${CLASS_DIR}")
  set(ABS_PLUGINS_PATH "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${PLUGINS_DIR}")

  set(ABS_CONF_PREFIX "$ENV{DESTDIR}${CONF_PREFIX}")
  set(ABS_HOME_PREFIX "$ENV{DESTDIR}${HOME_PREFIX}")
  set(ABS_EXEC_PREFIX "$ENV{DESTDIR}${EXEC_PREFIX}")

  set(ABS_CONF_SOURCE_PATH "$ENV{DESTDIR}${CONF_PREFIX}/${DIR_NAME}/${SOURCE_DIR}")
  set(ABS_CONF_PATH "$ENV{DESTDIR}${CONF_PREFIX}/${DIR_NAME}")
  set(ABS_INIT_PATH "$ENV{DESTDIR}${INIT_DIR}")
  set(ABS_LOG_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/${LOG_DIR}")
  set(ABS_LOCK_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/${LOCK_DIR}")
  set(ABS_RUNTIME_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/${RUNTIME_DIR}")
  set(ABS_PID_PATH "$ENV{DESTDIR}${EXEC_PREFIX}/${PID_DIR}")

  set (CMAKE_SKIP_BUILD_RPATH  FALSE)
  set (CMAKE_BUILD_WITH_INSTALL_RPATH FALSE)
  set (CMAKE_INSTALL_RPATH "${ABS_LIB_PATH}")

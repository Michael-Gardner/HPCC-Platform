...
IF (NOT LIBMEMCACHED_FOUND)
    ...
    if(NOT LIBMEMCACHED_FOUND AND MEMCACHED_USE_EXTERNAL_LIBRARY)
        ...
        add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_BINARY_DIR}/libmemcached-${LIBMEMCACHED_VERSION} ${CMAKE_CURRENT_BINARY_DIR}/libmemcached-${LIBMEMCACHED_VERSION}/configure --prefix=\"${ABS_LIB_PATH}\" LDFLAGS=\"-L${ABS_LIB_PATH}\" > /dev/null
            COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_BINARY_DIR}/libmemcached-${LIBMEMCACHED_VERSION} ${CMAKE_MAKE_PROGRAM} DESTDIR=\"${CMAKE_CURRENT_BINARY_DIR}\" LDFLAGS=\"-Wl,-rpath-link,${ABS_LIB_PATH}\" > /dev/null

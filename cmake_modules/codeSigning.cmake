...
function(configure_windows_signing target_name package_file_path)
    ...
    if("${DIGICERT_KEYPAIR_ALIAS}" NOT STREQUAL "")
    ...
    if(DO_CODE_SIGNING)
        ...
        set(CPACK_NSIS_FINALIZE_CMD "smctl sign --simple --keypair-alias \\\"${DIGICERT_KEYPAIR_ALIAS}\\\" --exit-non-zero-on-fail --failfast --input")
        ...
        add_custom_target(${target_name}
            COMMAND smctl sign --simple --input "${package_file_path}" --keypair-alias "${DIGICERT_KEYPAIR_ALIAS}" --exit-non-zero-on-fail --failfast

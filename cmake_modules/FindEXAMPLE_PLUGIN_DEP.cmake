...
# - Try to find any DEPendencies required for the example plugin/library
# Once done this will define
#
#  EXAMPLE_PLUGIN_DEP_FOUND - system has the dependencies
#  EXAMPLE_PLUGIN_DEP_INCLUDE_DIR - the dependency include directory(s)
#  EXAMPLE_PLUGIN_DEP_LIBRARIES - The dependency library needed.
...
IF (NOT EXAMPLE_PLUGIN_DEP_FOUND)
  ...
  #in which case this can be extracted
  #such that a minimum version check can be conducted at cmake configuration time.
  #In this example the following is being extracted from a C header file:
  ...
  #HPCC/plugins/exampleplugin/CMakeLists.txt:ADD_PLUGIN(EXAMPLE-PLUGIN PACKAGES EXAMPLE_PLUGIN_DEP MINVERSION 4.6.2)
  IF  (EXAMPLE_PLUGIN_DEP_INCLUDE_DIR)
    ...
    IF ("${EXAMPLE_PLUGIN_DEP_VERSION_STRING}" VERSION_LESS "${EXAMPLE_PLUGIN_DEP_FIND_VERSION}")
      #SET (EXAMPLE_PLUGIN_DEP_VERSION_OK 0)
  ...
  #EXAMPLE_PLUGIN_DEP_VERSION_OK) have not been set MAKE_EXAMPLE-PLUGIN will be set false when
  ...
  find_package_handle_standard_args(exampleplugin ${MSG}
    EXAMPLE_PLUGIN_DEP_LIBRARIES
    EXAMPLE_PLUGIN_DEP_INCLUDE_DIR
    EXAMPLE_PLUGIN_DEP_VERSION_OK
  )

  #I don't believe this is needed, why do we do this?
  MARK_AS_ADVANCED(EXAMPLE_PLUGIN_DEP_INCLUDE_DIR EXAMPLE_PLUGIN_DEP_LIBRARY)
ENDIF()

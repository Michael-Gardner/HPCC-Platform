...
[[ -n ${INPUT_SIGN_MODULES_PASSPHRASE} ]] && SIGN_MODULES_PASSPHRASE=${INPUT_SIGN_MODULES_PASSPHRASE}
[[ -n ${INPUT_SIGN_MODULES_KEYID} ]] && SIGN_MODULES_KEYID=${INPUT_SIGN_MODULES_KEYID}

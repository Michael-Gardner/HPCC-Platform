...
class hpccpkg:
    ...
    def copy(self):
        ...
        try:
            process = subprocess.run(create_container.split(), capture_output=True,
        ...
        try:
            process = subprocess.run(copy_artifact.split(), capture_output=True,
    ...
    def __init__(self, path, tag, repository='hpcc-systems', branch='master',

...
time_24_hours_ago = current_time - timedelta(hours=64)
...
for version in version_list:
  ...
  logging.info(f"Creating {data_dir_base}/LN-Candidate-{base_version}/bin/platform directory")
  os.makedirs(f"{data_dir_base}/LN-Candidate-{base_version}/bin/platform", exist_ok=True)
  os.chdir(f"{data_dir_base}/LN-Candidate-{base_version}/bin/platform")
  for distribution in redhat_distributions:
